...
export const AUTOCOMPLETE_ITEMS: AutocompleteItem[] = [
  ...
  {
    label: "Para ... Hasta ... Hacer",
    snippet: "Para i <- 1 Hasta 10 Con Paso 1 Hacer\n\t\nFinPara",
    category: "Bucles",
  },
