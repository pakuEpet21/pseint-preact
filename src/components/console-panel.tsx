...
export function ConsolePanel({
  ...
  if (consoleFontSize) {
    ...
    consoleStyle.lineHeight = simple
      ? `${consoleFontSize * 1.25}px`
            ...
            return (
              ...
              >
                <div className="flex items-start gap-1.5">
                  <span
                    className={
                      simple ? "text-destructive" : "mt-0.5 text-destructive"
                    }
                  >
                    ●
                  </span>
                  ...
                  <span
                    className={
                      simple
                        ...
                        : "shrink-0 rounded bg-chart-2/15 px-1.5 py-0.5 text-xs font-semibold text-chart-2"
                    }
                  >
                    {line.variable}
                  </span>
        ...
        {waitingForInput && (
          ...
          >
            ...
            <input
              ...
              className={
                simple
                  ? "flex-1 border-b border-primary/50 bg-transparent text-xs outline-none"
                  : "flex-1 border-b border-primary/50 bg-transparent pb-0.5 text-foreground outline-none"
              }
